  ...
  <div class="text-center section">
    ...
    >
      <template v-slot:day-content="{ day, attributes }" class="bg-light">
        <div   @dblclick="aaaa(day.date)"  class="flex flex-col h-full z-10 overflow-hidden h-100 w-100 d-inline-flex justify-content-center flex-column">
          <span  class="day-label text-sm text-gray-900 day-orange">{{ day.day }}</span>
