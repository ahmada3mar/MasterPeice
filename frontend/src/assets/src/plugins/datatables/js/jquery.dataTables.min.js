...
(function (f) {
  ...
  function ub(a) {
    var b = a.oClasses,
      ...
      e = a.oPreviousSearch,
      h = a.aanFeatures,
      g = '<input id="yy" type="search" class="' + b.sFilterInput + '"/>',
      k = d.sSearch;
    ...
    var l = $("#searcha").val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", g ? Sa(h, g) : h).on("keypress.DT", function (a) {
  ...
  function Nb(a) {
    ...
    for (var d = 0, e = b.length; d < e; d++) {
      ...
      h.bSortable && (0 < c.length && c[0].col == d ? (f.setAttribute("aria-sort", "ascending" == c[0].dir ? "ascending" : "descending"), h = g[c[0].index + 1] || g[0]) : h = g[0], k += "asc" === h ? a.sSortAscending : a.sSortDescending);
  ...
  f.extend(q.ext.classes, {
    ...
    sStripeOdd: "odd",
    sStripeEven: "even",
    sRowEmpty: "tablesorter-headerUnSorted",
    sWrapper: "dataTables_wrapper",
    sFilter: "",
    sInfo: "dataTables_info",
    sPaging: "dataTables_paginate paging_",
    sLength: "dataTables_length",
    sProcessing: "tablesorter-headerUnSorted",
    sSortAsc: "tablesorter-headerAsc",
    sSortDesc: "tablesorter-headerDesc",
    sSortable: "sorting",
    sSortableAsc: "tablesorter-headerUnSorted",
    sSortableDesc: "tablesorter-headerDesc",
    sSortableNone: "tablesorter-headerUnSorted",
    sSortColumn: "sorting_",
    sFilterInput: "",
    sLengthSelect: "",
    sScrollWrapper: "dataTables_scroll",
    sScrollHead: "tablesorter-headerRow",
          ...
          t = function (b, d) {
            ...
            for (p = d.length; w < p; w++) {
              ...
              if (f.isArray(v)) {
                ...
                switch (v) {
                  case "ellipsis":
                    b.append('<span class="tablesorter-headerUnSorted">&#x2026;</span>');
                    break;
                  case "first":
                    n = k.sFirst;
                    0 === e && (x = -1, m += " " + r);
