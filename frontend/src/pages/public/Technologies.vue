			...
			<div class="col-12 col-md-6 align-items-center d-inline-flex ">
				<div class="py-4">
					...
					<h3 class="description mt-2">
						...
						interactive learning experience, based on the market needs and
						divided into frontend and backend sections to graduate a generation
						of fully qualified full-stack web developers.
					</h3>
				</div>
			</div>
