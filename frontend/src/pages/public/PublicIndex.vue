        ...
        <div claSS="container">
          <div claSS="row justify-content-center">
            <div>
              <div claSS="row  ">
                <div
                  claSS="col-md-4 col-12 d-inline-flex justify-content-stretch my-md-0 my-2"
                >
                  <div claSS="card border">
                    ...
                    <div claSS="card-body position-static">
                      <h3 claSS="card-title mb-2">Technologies</h3>
                ...
                >
                  <div claSS="card border">
                    ...
                    />
                    <div claSS="card-body position-static">
                      <h3 claSS="card-title mb-2">About Us</h3>
                      <p claSS="card-text mb-3" lang="zxx">
                ...
                >
                  <div claSS="card border">
                    ...
                    />
                    <div claSS="card-body position-static">
                      <h3 claSS="card-title mb-2">Contact Us</h3>
                      <p claSS="card-text mb-3" lang="zxx">
            ...
            <div claSS="col-12">
              <div claSS="row">
                ...
                >
                  ...
                  <div>
                    <div class="btn btn-primary float-left my-3 float-md-right">
                      See More
                    </div>
                  </div>
                </div>
